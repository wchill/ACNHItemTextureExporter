...
namespace ACNHItemTextureExporter
{
    public static class TegraX1Swizzle
    {
        ...
        private static byte[] Swizzle(uint width, uint height, uint blkWidth, uint blkHeight, int roundPitch, uint bpp, uint tileMode, int blockHeightLog2, byte[] data, int toSwizzle)
        {
